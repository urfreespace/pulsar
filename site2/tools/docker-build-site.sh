...
sed -i .bak "s#$ROOT_DIR#/pulsar#g" $ROOT_DIR/distribution/server/target/classpath.txt
sed -i .bak "s#$HOME#/root#g" $ROOT_DIR/distribution/server/target/classpath.txt
